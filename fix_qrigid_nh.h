...
#ifndef LMP_FIX_QRIGID_NH_H
#define LMP_FIX_QRIGID_NH_H

#include "fix_qrigid.h"

namespace LAMMPS_NS {

class FixQRigidNH : public FixQRigid {
 public:
  FixQRigidNH(class LAMMPS *, int, char **);
  virtual ~FixQRigidNH();
  virtual int setmask();
  virtual void init();
...
inline double FixQRigidNH::maclaurin_series(double x)
{
  double x2,x4;
  x2 = x * x;
  x4 = x2 * x2;
